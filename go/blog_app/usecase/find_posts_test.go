				...
				[]postOutput{
					{
						...
						[]commentOutput{
							{
								ID:        randomComments[2].ID(),
								Body:      randomComments[2].Body(),
								CreatedAt: modeltime.Time{Time: randomComments[2].CreatedAt()},
								UpdatedAt: modeltime.Time{Time: randomComments[2].UpdatedAt()},
							},
						},
					},
				},
